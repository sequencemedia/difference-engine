(function ($, K) {
	if ((($ || false).constructor === Function) && ((K || false).constructor === Object)) {
		K.differenceEngine = (function () {
			var has, positive, negative, model;
			has = (function () {
				var i, j, key;
			...
			model = (function () {
				var index, total, value, find, L, R;
				find = (function () {
					var i, j, IDENTIFIER;
				...
				L = (function () {
					var j, n, IDENTIFIER;
					return function L(i, positive, negative, identifier) {
						j = 0;
						while (i > j) {
							i = i - 1;
				...
				R = (function () {
					var j, n, IDENTIFIER;
					return function R(i, positive, negative, identifier) {
						j = (positive.length - 1);
						while (i < j) {
							i = i + 1;
							IDENTIFIER = positive[i];
			...
			return function DifferenceEngine(CONFIG) {
